...
ap.add_argument("--base_path", type=str, default='/expanse/lustre/scratch/yzhang39/temp_project/random_exp')
...
if config.wandb.use:
    ...
    wandb.init(
        ...
        config=config,
        name="{}_train_model_{}_method_{}_mask_{}_ratio_{}_prompt_{}_attn_{}".format(
            eid[:5],
